...
# train_dataset_clip = FisVDataset(video_path, train_label_path, clip_num=clip_num,
#                                  score_type=score_type,
#                                  train=True)  # , action_masks=True)#, vision_vlm_inject_path="/archive1/arr159/gdlt/clip/middle")
# train_clip_loader = DataLoader(train_dataset_clip, batch_size=1, shuffle=False, num_workers=0)
#
# train_clip_iterator = iter(train_clip_loader)
# binning
import numpy as np
...
def get_graphic(args, goe_bin_cossim_lookup_positive, goe_bin_cossim_lookup_negative):
    ...
    plt.tight_layout()
    plt.savefig(f'/afs/cs.pitt.edu/usr0/arr159/figure_skating/CVPR22_GDLT/analysis/outputs/{args.save_name}.png', format='png', dpi=300)
