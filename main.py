...
if __name__ == '__main__':
    ...
    if args.dataset_name == 'fs800':
        ...
        pretraining_dataset_class = FS800PretrainingDataset if args.dataset_name == 'fs800' else FisVDataset
    ...
    if args.pretraining:
        ...
        from models import regularization_loss
        regularization_fn = regularization_loss.RegularizationLossFn(args.ortho_loss, args.peak_loss, args.sliding_peak_loss, args.clip_l1_norm, args)
    else:
    ...
    for epc in pbar:
        ...
        avg_loss, train_coef = train_fn(epc, model, loss_fn, train_loader, optim, logger, device, args, wandb)
