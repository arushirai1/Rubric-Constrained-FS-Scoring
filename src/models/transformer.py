...
class TransformerDecoder(Module):
    ...
    def forward(self, tgt: Tensor, memory: Tensor, tgt_mask: Optional[Tensor] = None,
                ...
                memory_key_padding_mask: Optional[Tensor] = None, need_weights: bool = False) -> Tensor:
        ...
        for mod in self.layers:
            output, att_weights = mod(output, memory, tgt_mask=tgt_mask,
                         ...
                         tgt_key_padding_mask=tgt_key_padding_mask,
                         memory_key_padding_mask=memory_key_padding_mask, need_weights=need_weights)
...
class TransformerDecoderLayer(Module):
    ...
    def forward(self, tgt: Tensor, memory: Tensor, tgt_mask: Optional[Tensor] = None, memory_mask: Optional[Tensor] = None,
        ...
        Args:
            ...
            tgt_key_padding_mask: the mask for the tgt keys per batch (optional).
            memory_key_padding_mask: the mask for the memory keys per batch (optional).
            need_weights: return attention maps, slower when set to True (bool, optional).
